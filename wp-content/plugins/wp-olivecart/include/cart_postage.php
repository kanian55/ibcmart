...
function wp_olivecart_setup_menu(){
	...
	if($Role){
	$hook1 = add_menu_page(__('Shopping Cart Setup','WP-OliveCart'),'OliveCart_Setup',$Role, 'olivecart_postage',array(&$cart_postage, 'on_show_page'),WP_PLUGIN_URL.'/wp-olivecart/images/icon_cart.png');
	...
	add_menu_page('Item info',__('Item','WP-OliveCart'),$Role, 'edit.php?post_type=cart','',WP_PLUGIN_URL.'/wp-olivecart/images/icon_commodity.png');
